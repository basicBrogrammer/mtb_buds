...
ActiveRecord::Schema.define(version: 2019_08_09_023109) do
  ...
  create_table "participations", force: :cascade do |t|
    ...
    t.index ["user_id", "ride_id"], name: "index_participations_on_user_id_and_ride_id", unique: true
  ...
  create_table "rides", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["latitude", "longitude"], name: "index_rides_on_latitude_and_longitude"
